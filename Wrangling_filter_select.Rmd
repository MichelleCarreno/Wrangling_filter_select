...
It looks like this data is showing genres of movies ranging from action to shorts from 1939 until the 2000s. It shows the title of the movie the year of it, the length of the movie, the budget to make the movie, and the rating of the movie to see if people liked it. 
...
median(newdata)
```
 The median budget for movie is at 3000000.

```{r}
smovie<-sort(movieslength)
```
...
- What is the median budget for a movie? The median budget for the movie is at 2 million dollars. 

But after looking at all of the movies recorded here, the more precise questions might turn out to be:

- What is the average rating *of movies longer than 60 minutes?*  The average rating of the movie longer than 60 minutes is at about 90 minutes to be exact. 
...
1. How many movies were released in 1995?
  ...
  The amount of movies that were released in 1995, are
